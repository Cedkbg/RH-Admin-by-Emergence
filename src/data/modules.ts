...
export const modules: AppModule[] = [
  { id: "dashboard", label: "Tableau de bord", path: "/", icon: LayoutDashboard, color: "blue", shortDescription: "Vue d'ensemble RH" },
  { id: "org", label: "Organigramme", path: "/organigramme", icon: Network, color: "indigo", shortDescription: "Structure de l'entreprise" },
  { id: "employees", label: "Employés", path: "/employes", icon: Users, color: "blue", shortDescription: "Gérez les profils des employés" },
  ...
  { id: "documents", label: "Documents RH", path: "/documents", icon: FileText, color: "purple", shortDescription: "Stockez et gérez les documents RH" },
  ...
  { id: "reports", label: "Rapports & Analyses", path: "/rapports", icon: BarChart3, color: "blue", shortDescription: "Tableaux de bord et HR Analytics" },
...
// Mapping color → classes Tailwind (texte + fond clair pour les icônes)
