  ...
  return (
    <div className="mx-auto max-w-[1200px] space-y-6 animate-fade-in">
      ...
      <section className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
        <Link to="/taches" className="group rounded-xl border bg-card p-5 shadow-sm hover:shadow-md transition-all hover:-translate-y-0.5">
          <div className="flex items-center gap-3">
            <div className="h-11 w-11 rounded-lg bg-module-blue/10 text-module-blue flex items-center justify-center">
              <ListChecks className="h-5 w-5" />
            </div>
            <div>
              <h3 className="font-semibold">Mes tâches</h3>
              <p className="text-xs text-muted-foreground">Projets &amp; tâches</p>
            </div>
          </div>
        </Link>
        <Link to="/communication" className="group rounded-xl border bg-card p-5 shadow-sm hover:shadow-md transition-all hover:-translate-y-0.5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Annonces internes</p>
            </div>
          </div>
        </Link>
